	...
	async getPublishedPosts(
		...
		let query = this.supabase
			...
			.select(`
			 ...
			 github_repo_url, github_stars, github_forks, github_homepage_url, github_pricing_url, github_license,
			 min_price, max_price, offer_free, prev_min_price, prev_max_price, in_promotion,
			 social_medias, voucher_codes
		`)
