	...
	addNodeView() {
		return ({
			...
			dom.addEventListener("click", (e) => {
				...
				// Use Valtio state to trigger citation dialog in main editor
				editorDialogActions.openCitationDialog({
					id: node.attrs.id || "",
	...
	addNodeView() {
		return ({
			...
			dom.addEventListener("click", (e) => {
				...
				// Use Valtio state to trigger footnote dialog in main editor
				editorDialogActions.openFootnoteDialog({
					id: node.attrs.id || "",
					text: node.attrs.text || "",
					pos: getPos(),
					nodeType: node.type,
