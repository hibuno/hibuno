  ...
  useEffect(() => {
    ...
    return () => {
      ...
      document.removeEventListener(
        "imageEdit",
        handleImageEdit as EventListener,
      );
      document.removeEventListener(
        "editMathLatex",
        handleMathLatexEdit as EventListener,
      ...
      <div className="relative bg-white">
        ...
        {showLaTeXDialog && (
          <ToolbarLaTeXDialog
            ...
            onInsert={
              editingMathLatex ? handleMathLatexUpdate : handleLaTeXInsert
            }
            {...(editingMathLatex && {
              initialData: {
        ...
        {showCitationDialog && (
          <ToolbarCitationDialog
            ...
            onInsert={
              editingCitation ? handleCitationUpdate : handleCitationInsert
            }
            {...(editingCitation && {
              initialData: {
        ...
        {showFootnoteDialog && (
          <ToolbarFootnoteDialog
            ...
            onInsert={
              editingFootnote ? handleFootnoteUpdate : handleFootnoteInsert
            }
            {...(editingFootnote && {
              initialData: {
