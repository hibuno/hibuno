...
export async function generateMetadata({
 ...
 if (!analysis) {
  return {
   ...
   description: "The requested image analysis could not be found.",
  };
 }

 return {
  title: `${analysis.filename} Analysis - Hibuno Image Analysis Tool`,
  description: `View detailed analysis of ${analysis.filename} including EXIF data, AI detection, and color information.`,
  openGraph: {
   title: `Image Analysis Results - ${analysis.filename}`,
   description: `View detailed analysis of ${analysis.filename} including EXIF data, AI detection, and color information.`,
   type: "website",
